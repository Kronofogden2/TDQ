...
buttonÅr0.addEventListener("click", function () {
    ...
    if (!isNaN(parseInt(egetkapital.value) + parseInt(långfristigaskulder.value) + parseInt(kortfristigaskulder.value))) {
        ...
        chapterData.push({
            ...
            eget_kapital: parseInt(egetkapital.value),
...
function createChapter() {
    ...
    /*7 */{ id: "Rörelseresultat", input: document.createElement("input"), label: "Rörelseresultat" },                          //Not calculated
    ...
    /*11*/{ id: "ÅretsResultat", input: document.createElement("input"), label: "Årets Resultat" },                             //Not calculated
    ...
    button.addEventListener("click", function () {
        ...
        <input type="text" value="${Math.round((balansräkning.summa_tillgångar + balansräkning.summa_kapital_skulder) / balansräkning.eget_kapital * 100)}" disabled>
        <p class="currency">%</p>

        <label>Räntabilitet på sysselsatt kapital</label>
        <input type="text" value="${Math.round((balansräkning.summa_tillgångar + balansräkning.summa_kapital_skulder) / (balansräkning.eget_kapital + balansräkning.långfristiga_skulder) * 100)} " disabled>
        <p class="currency">%</p>
